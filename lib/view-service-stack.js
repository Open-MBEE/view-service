const {Construct, Duration, RemovalPolicy, Stack, StackProps} = require('@aws-cdk/core');
const {Port, SecurityGroup, Vpc} = require('@aws-cdk/aws-ec2');
const {Effect, ManagedPolicy, Policy, PolicyStatement, Role, RoleProps, ServicePrincipal} = require('@aws-cdk/aws-iam');
const {Runtime} = require('@aws-cdk/aws-lambda');
const {CfnDBCluster, CfnDBInstance, CfnDBSubnetGroup} = require('@aws-cdk/aws-neptune');
...
const {LambdaInvoke} = require('@aws-cdk/aws-stepfunctions-tasks');

const path = require('path');

class ViewServiceStack extends Stack {
    /**
     *
    ...
    constructor(scope, id, props) {
         ...
         */
        const createLambdaRole = function (stack, id, props) {
            return new Role(stack, id, {
                assumedBy: new ServicePrincipal('lambda.amazonaws.com'),
                ...(rolePrefix) && {roleName: `${rolePrefix}${stack.stackName}${id}`},
        ...
        const exportConfluenceLambda = new NodejsFunction(this, 'ExportConfluence', {
            ...
            environment: {
                // TODO Pull from AWS Secrets Manager / Systems Manager / etc.
                'CONFLUENCE_TOKEN': '',
