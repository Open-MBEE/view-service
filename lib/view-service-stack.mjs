...
import {Choice, Condition, Map, Pass, Result, StateMachine, Succeed, TaskInput, IntegrationPattern} from '@aws-cdk/aws-stepfunctions';
import {LambdaInvoke, EcsRunTask, EcsFargateLaunchTarget} from '@aws-cdk/aws-stepfunctions-tasks';
import {FargateTaskDefinition, FargatePlatformVersion, ContainerImage, LogDriver, ICluster, Cluster} from '@aws-cdk/aws-ecs';
...
export class ViewServiceStack extends Stack {
    ...
    constructor(scope, id, props) {
        ...
        const regenerateTaskDefinition = new FargateTaskDefinition(this, 'RegenerateDiagramTask', {
            executionRole: vpcAccessLambdaRole,
            taskRole: vpcAccessLambdaRole,
            memoryLimitMiB: 30720,
            cpu: 4096,
        }).addContainer('RegenerateDiagramContainer', {
            image: ContainerImage.fromRegistry('cae-artifactory.jpl.nasa.gov:17001/openmbee/mms-neptune:latest'),
            essential: true,
            memoryLimitMiB: 30720,
            cpu: 4096,
            environment: {
        ...
        const regenerateDiagrams = new EcsRunTask(this, 'Regenerate Diagrams for ' + `$.impl.stack[0]`, {
        ...
        const stateMachineEventPolicy = new Policy(this, 'StateMachineEventsPolicy', {
            statements: [
                new PolicyStatement({
                    effect: Effect.ALLOW,
                    resources: [viewServiceStateMachine.stateMachineArn],
                    actions: [
