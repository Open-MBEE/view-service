...
import {FargateTaskDefinition, FargatePlatformVersion, ContainerImage, LogDriver, Cluster} from '@aws-cdk/aws-ecs';
...
export class ViewServiceStack extends Stack {
    ...
    constructor(scope, id, props) {
        ...
        const notificationEndpointKey = scope.node.tryGetContext('notification_endpoint');
        ...
        const containerDefinition = regenerateTaskDefinition.addContainer('RegenerateDiagramContainer', {
            ...
            environment: {
                ...
                WIKI_SPACE: '',
                'NEPTUNE_ENDPOINT': `https://${neptuneCluster.attrEndpoint}:8182/sparql`,
            },
